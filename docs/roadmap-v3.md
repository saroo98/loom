...
| Current generated inventory | 1,332 test methods in 119 modules | Repository inventory only; it does not say the full suite passed in this documentation update |
