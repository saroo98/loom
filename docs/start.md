...
The current signed release is **Loom 1.8.26**.
...
## Download and verify Loom 1.8.26

Open the immutable
[Loom 1.8.26 release](https://github.com/saroo98/loom/releases/tag/v1.8.26) and download
`loom-plugin-v1.8.26.zip`.
