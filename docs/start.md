...
The current signed release is **Loom 1.8.25**.
...
## Download and verify Loom 1.8.25

Open the immutable
[Loom 1.8.25 release](https://github.com/saroo98/loom/releases/tag/v1.8.25) and download
`loom-plugin-v1.8.25.zip`.
